...
//    }
//
//    @When("Fill all input fields in register account page {string} {string} {string}{string} {string} {string} {string}:")
...
//
//
//    @When("Fill all input fields in register account page, existing email address {string} {string} {string}{string} {string} {string} {string}:")
