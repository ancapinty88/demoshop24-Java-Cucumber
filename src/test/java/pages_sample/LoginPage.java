...
public class LoginPage {
    ...
    public void myAccountSectionIsVisible() {
        ...
        assertTrue(myAccountSection.isDisplayed());
     }


    public void myOrdersSectionIsVisible() { assertTrue(myOrdersSection.isDisplayed()); }

    public void myAffiliateAccountSectionIsVisible() { assertTrue(myAffiliateAccountSection.isDisplayed()); }

    public void newsletterSectionIsVisible() { assertTrue(newsletterSection.isDisplayed()); }
